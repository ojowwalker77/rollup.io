  ...
  levels: [
    {
      id: "l1-launch",
      name: "Launch",
      situation: "Launch week. The first guests are about to hit the booking page — and it's just you on call.",
    ...
    },
    {
      ...
      situation: "A travel blogger linked you. Traffic doubled overnight — and now the CFO is watching the bill.",
    ...
    },
    {
      ...
      situation: "A huge conference hits town this weekend — everyone books in the same hour, and bookings are writes.",
    ...
    },
    {
      ...
      situation: "Peak season across every property at once. The SLA tightens, and the budget is now your score.",
