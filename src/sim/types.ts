...
export type ReqClass = "read" | "write" | "kv" | "media" | "search" | "event" | "realtime" | "inference";
export const REQ_CLASSES: readonly ReqClass[] = ["read", "write", "kv", "media", "search", "event", "realtime", "inference"];
